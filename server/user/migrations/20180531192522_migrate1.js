exports.up = function (knex, Promise) {
    return Promise.all([
        ...
        knex.schema.createTable('teams_list', function (t) {
        ...
        knex.schema.createTable('team_details', function (t) {
            t.integer('team_id').references('teams_list.team_id');
        ...
        knex.schema.createTable('match_details', function (t) {
            ...
            t.integer('category_id').references('game_category_details.category_id');
            t.integer('team1_id').references('teams_list.team_id');
            t.integer('team2_id').references('teams_list.team_id');
...
exports.down = function (knex, Promise) {
    return Promise.all([
        ...
        knex.schema.dropTable('teams_list'),
